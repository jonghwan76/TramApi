...
/*			if(!(!o.follow[1] && fixedVPos || fixedPosStyle)){
				alert('a');
			}else{
				alert('b');
			}*/
			
//			alert(vPos +"|"+d.scrollTop());
...
//       		alert(wW+" | "+$('.b-iframe').outerWidth(true));
			vPos 		= fixedVPos ? o.position[1] : Math.max(0, ((wH- $popup.outerHeight(true)) / 2) - o.amsl)
			, hPos 		= fixedHPos ? o.position[0] : (wW - $popup.outerWidth(true)) / 2
//			, hPos 		= fixedHPos ? o.position[0] : (wW - $('#element_to_pop_up').outerWidth(true)) / 2
			, inside 	= insideWindow();
//			alert(wW +"|"+$popup.outerWidth(true));
		};
